...
namespace Spacebuilder.Iditu
{
    ...
    /// 帖吧应用数据Url获取器
    /// </summary>
    public class IdituApplicationStatisticDataGetter : IApplicationStatisticDataGetter
    {
        private IdituService IdituService = new IdituService();
        /// <summary>
        /// 获取管理数据
        /// </summary>
        ...
        public IEnumerable<ApplicationStatisticData> GetManageableDatas(string tenantTypeId = null)
        {
            ...
            /*
            Dictionary<string, long> microBlogManageableDatas = IdituService.GetManageableDatas(tenantTypeId);
        ...
        public IEnumerable<ApplicationStatisticData> GetStatisticDatas(string tenantTypeId = null)
        {
            IList<ApplicationStatisticData> applicationStatisticDatas = new List<ApplicationStatisticData>();
            /*
            Dictionary<string, long> microBlogStatisticDatas = IdituService.GetStatisticDatas(tenantTypeId);
