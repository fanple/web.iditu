...
namespace Spacebuilder.Iditu
{
    ...
    /// Iditu应用
    /// </summary>
    public class IdituApplication : ApplicationBase
    {

        protected IdituApplication(ApplicationModel model, ApplicationConfig config)
            : base(model, config)
        { }
        ...
        {
            //IdituService repairService = new IdituService();
